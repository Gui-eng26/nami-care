...
export const medicamentos = [
  ...
  { idoso: 'Cecília Prado', nome: 'Paracetamol', dosagem: '750 mg', forma: 'comprimido', posologia: 'Se dor ou febre, até 3x ao dia (NUNCA dipirona — alergia)', tipo: 'sos', horarios: [], estoqueInicial: 20, estoqueMinimo: 10 },
  ...
  { idoso: 'Firmino Duarte', nome: 'Dipirona', dosagem: '1 g', forma: 'comprimido', posologia: 'Se dor, até 4x ao dia', tipo: 'sos', horarios: [], estoqueInicial: 20, estoqueMinimo: 10 },
  ...
  { idoso: 'Iracema Barros', nome: 'Simeticona', dosagem: '125 mg', forma: 'cápsula', posologia: 'Se desconforto abdominal, até 3x ao dia', tipo: 'sos', horarios: [], estoqueInicial: 20, estoqueMinimo: 8 },
